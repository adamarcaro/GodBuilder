...
public class FragmentHades extends Fragment {

    View myView;

    public FragmentHades() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_hades, container, false);
        ...
        starter.setImageResource(getImage("hades_starter"));
        relic1.setImageResource(getImage("hades_relic1"));
        relic2.setImageResource(getImage("hades_relic2"));
        item1.setImageResource(getImage("hades_item1"));
        item2.setImageResource(getImage("hades_item2"));
        item3.setImageResource(getImage("hades_item3"));
        item4.setImageResource(getImage("hades_item4"));
        item5.setImageResource(getImage("hades_item5"));
        item6.setImageResource(getImage("hades_item6"));

        //Loading build names
        starterName.setText(getName("hades_starter_name"));
        relic1Name.setText(getName("hades_relic1_name"));
        relic2Name.setText(getName("hades_relic2_name"));
        item1Name.setText(getName("hades_item1_name"));
        item2Name.setText(getName("hades_item2_name"));
        item3Name.setText(getName("hades_item3_name"));
        item4Name.setText(getName("hades_item4_name"));
        item5Name.setText(getName("hades_item5_name"));
        item6Name.setText(getName("hades_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_starter_name", name);
                        saveImage("hades_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_relic1_name", name);
                        saveImage("hades_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_relic2_name", name);
                        saveImage("hades_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_item1_name", name);
                        saveImage("hades_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_item2_name", name);
                        saveImage("hades_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_item3_name", name);
                        saveImage("hades_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_item4_name", name);
                        saveImage("hades_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_item5_name", name);
                        saveImage("hades_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hades_item6_name", name);
                        saveImage("hades_item6", resourceId);
