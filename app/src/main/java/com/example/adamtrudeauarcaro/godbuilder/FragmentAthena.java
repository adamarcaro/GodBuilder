...
public class FragmentAthena extends Fragment {

    View myView;

    public FragmentAthena() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_athena, container, false);
        ...
        starter.setImageResource(getImage("athena_starter"));
        relic1.setImageResource(getImage("athena_relic1"));
        relic2.setImageResource(getImage("athena_relic2"));
        item1.setImageResource(getImage("athena_item1"));
        item2.setImageResource(getImage("athena_item2"));
        item3.setImageResource(getImage("athena_item3"));
        item4.setImageResource(getImage("athena_item4"));
        item5.setImageResource(getImage("athena_item5"));
        item6.setImageResource(getImage("athena_item6"));

        //Loading build names
        starterName.setText(getName("athena_starter_name"));
        relic1Name.setText(getName("athena_relic1_name"));
        relic2Name.setText(getName("athena_relic2_name"));
        item1Name.setText(getName("athena_item1_name"));
        item2Name.setText(getName("athena_item2_name"));
        item3Name.setText(getName("athena_item3_name"));
        item4Name.setText(getName("athena_item4_name"));
        item5Name.setText(getName("athena_item5_name"));
        item6Name.setText(getName("athena_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_starter_name", name);
                        saveImage("athena_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_relic1_name", name);
                        saveImage("athena_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_relic2_name", name);
                        saveImage("athena_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_item1_name", name);
                        saveImage("athena_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_item2_name", name);
                        saveImage("athena_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_item3_name", name);
                        saveImage("athena_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_item4_name", name);
                        saveImage("athena_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_item5_name", name);
                        saveImage("athena_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("athena_item6_name", name);
                        saveImage("athena_item6", resourceId);
