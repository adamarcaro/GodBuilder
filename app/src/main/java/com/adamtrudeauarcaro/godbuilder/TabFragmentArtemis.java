...
public class TabFragmentArtemis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.artemis);
        godName.setText(R.string.artemis);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.artemis_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentArtemis1();
                case 1 : return new FragmentArtemis2();
                case 2 : return new FragmentArtemis3();
            }
            return null;
        }
