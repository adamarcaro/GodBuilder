...
public class TabFragmentXbalanque extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.xbalanque);
        godName.setText(R.string.xbalanque);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_mayan,0);
        godTitle.setText(R.string.xbalanque_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentXbalanque1();
                case 1 : return new FragmentXbalanque2();
                case 2 : return new FragmentXbalanque3();
            }
            return null;
        }
