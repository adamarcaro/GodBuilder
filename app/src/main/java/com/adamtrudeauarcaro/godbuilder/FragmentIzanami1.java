...
public class FragmentIzanami1 extends Fragment {

    View myView;

    public FragmentIzanami1() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        starter.setImageResource(getImage("izanami_starter"));
        relic1.setImageResource(getImage("izanami_relic1"));
        relic2.setImageResource(getImage("izanami_relic2"));
        item1.setImageResource(getImage("izanami_item1"));
        item2.setImageResource(getImage("izanami_item2"));
        item3.setImageResource(getImage("izanami_item3"));
        item4.setImageResource(getImage("izanami_item4"));
        item5.setImageResource(getImage("izanami_item5"));
        item6.setImageResource(getImage("izanami_item6"));

        //Loading build names
        starterName.setText(getName("izanami_starter_name"));
        relic1Name.setText(getName("izanami_relic1_name"));
        relic2Name.setText(getName("izanami_relic2_name"));
        item1Name.setText(getName("izanami_item1_name"));
        item2Name.setText(getName("izanami_item2_name"));
        item3Name.setText(getName("izanami_item3_name"));
        item4Name.setText(getName("izanami_item4_name"));
        item5Name.setText(getName("izanami_item5_name"));
        item6Name.setText(getName("izanami_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_starter_name", name);
                        saveImage("izanami_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_relic1_name", name);
                        saveImage("izanami_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_relic2_name", name);
                        saveImage("izanami_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_item1_name", name);
                        saveImage("izanami_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_item2_name", name);
                        saveImage("izanami_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_item3_name", name);
                        saveImage("izanami_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_item4_name", name);
                        saveImage("izanami_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_item5_name", name);
                        saveImage("izanami_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("izanami_item6_name", name);
                        saveImage("izanami_item6", resourceId);
