...
public class TabFragmentTyr extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.tyr);
        godName.setText(R.string.tyr);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.tyr_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentTyr1();
                case 1 : return new FragmentTyr2();
                case 2 : return new FragmentTyr3();
            }
            return null;
        }
