...
public class TabFragmentRatatoskr extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.ratatoskr);
        godName.setText(R.string.ratatoskr);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.ratatoskr_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentRatatoskr1();
                case 1 : return new FragmentRatatoskr2();
                case 2 : return new FragmentRatatoskr3();
            }
            return null;
        }
