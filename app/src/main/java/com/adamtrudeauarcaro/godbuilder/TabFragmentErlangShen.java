...
public class TabFragmentErlangShen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.erlang_shen);
        godName.setText(R.string.erlang_shen);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.erlang_shen_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentErlangShen1();
                case 1 : return new FragmentErlangShen2();
                case 2 : return new FragmentErlangShen3();
            }
            return null;
        }
