...
public class FragmentSusano2 extends Fragment {

    View myView;

    public FragmentSusano2() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        starter.setImageResource(getImage("susano_starter_2"));
        relic1.setImageResource(getImage("susano_relic1_2"));
        relic2.setImageResource(getImage("susano_relic2_2"));
        item1.setImageResource(getImage("susano_item1_2"));
        item2.setImageResource(getImage("susano_item2_2"));
        item3.setImageResource(getImage("susano_item3_2"));
        item4.setImageResource(getImage("susano_item4_2"));
        item5.setImageResource(getImage("susano_item5_2"));
        item6.setImageResource(getImage("susano_item6_2"));

        //Loading build names
        starterName.setText(getName("susano_starter_name_2"));
        relic1Name.setText(getName("susano_relic1_name_2"));
        relic2Name.setText(getName("susano_relic2_name_2"));
        item1Name.setText(getName("susano_item1_name_2"));
        item2Name.setText(getName("susano_item2_name_2"));
        item3Name.setText(getName("susano_item3_name_2"));
        item4Name.setText(getName("susano_item4_name_2"));
        item5Name.setText(getName("susano_item5_name_2"));
        item6Name.setText(getName("susano_item6_name_2"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_starter_name_2", name);
                        saveImage("susano_starter_2", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_relic1_name_2", name);
                        saveImage("susano_relic1_2", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_relic2_name_2", name);
                        saveImage("susano_relic2_2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_item1_name_2", name);
                        saveImage("susano_item1_2", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_item2_name_2", name);
                        saveImage("susano_item2_2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_item3_name_2", name);
                        saveImage("susano_item3_2", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_item4_name_2", name);
                        saveImage("susano_item4_2", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_item5_name_2", name);
                        saveImage("susano_item5_2", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("susano_item6_name_2", name);
                        saveImage("susano_item6_2", resourceId);
