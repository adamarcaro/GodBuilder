...
public class TabFragmentKuzenbo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.kuzenbo);
        godName.setText(R.string.kuzenbo);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_japanese,0);
        godTitle.setText(R.string.kuzenbo_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentKuzenbo1();
                case 1 : return new FragmentKuzenbo2();
                case 2 : return new FragmentKuzenbo3();
            }
            return null;
        }
