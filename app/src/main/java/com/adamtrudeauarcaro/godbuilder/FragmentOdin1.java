...
public class FragmentOdin1 extends Fragment {

    View myView;

    public FragmentOdin1() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        starter.setImageResource(getImage("odin_starter"));
        relic1.setImageResource(getImage("odin_relic1"));
        relic2.setImageResource(getImage("odin_relic2"));
        item1.setImageResource(getImage("odin_item1"));
        item2.setImageResource(getImage("odin_item2"));
        item3.setImageResource(getImage("odin_item3"));
        item4.setImageResource(getImage("odin_item4"));
        item5.setImageResource(getImage("odin_item5"));
        item6.setImageResource(getImage("odin_item6"));

        //Loading build names
        starterName.setText(getName("odin_starter_name"));
        relic1Name.setText(getName("odin_relic1_name"));
        relic2Name.setText(getName("odin_relic2_name"));
        item1Name.setText(getName("odin_item1_name"));
        item2Name.setText(getName("odin_item2_name"));
        item3Name.setText(getName("odin_item3_name"));
        item4Name.setText(getName("odin_item4_name"));
        item5Name.setText(getName("odin_item5_name"));
        item6Name.setText(getName("odin_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_starter_name", name);
                        saveImage("odin_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_relic1_name", name);
                        saveImage("odin_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_relic2_name", name);
                        saveImage("odin_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item1_name", name);
                        saveImage("odin_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item2_name", name);
                        saveImage("odin_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item3_name", name);
                        saveImage("odin_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item4_name", name);
                        saveImage("odin_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item5_name", name);
                        saveImage("odin_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item6_name", name);
                        saveImage("odin_item6", resourceId);
