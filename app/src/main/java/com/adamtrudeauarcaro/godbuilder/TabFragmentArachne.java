...
public class TabFragmentArachne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.arachne);
        godName.setText(R.string.arachne);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.arachne_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentArachne1();
                case 1 : return new FragmentArachne2();
                case 2 : return new FragmentArachne3();
            }
            return null;
        }
