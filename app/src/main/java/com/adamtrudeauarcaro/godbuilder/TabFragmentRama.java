...
public class TabFragmentRama extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.rama);
        godName.setText(R.string.rama);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_hindu,0);
        godTitle.setText(R.string.rama_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentRama1();
                case 1 : return new FragmentRama2();
                case 2 : return new FragmentRama3();
            }
            return null;
        }
