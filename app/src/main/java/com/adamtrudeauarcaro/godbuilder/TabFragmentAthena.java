...
public class TabFragmentAthena extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.athena);
        godName.setText(R.string.athena);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.athena_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentAthena1();
                case 1 : return new FragmentAthena2();
                case 2 : return new FragmentAthena3();
            }
            return null;
        }
