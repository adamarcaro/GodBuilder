...
public class TabFragmentFafnir extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.fafnir);
        godName.setText(R.string.fafnir);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.fafnir_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentFafnir1();
                case 1 : return new FragmentFafnir2();
                case 2 : return new FragmentFafnir3();
            }
            return null;
        }
