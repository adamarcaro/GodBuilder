...
public class FragmentNike extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_nike, container, false);
        ...
        starter.setImageResource(getImage("nike_starter"));
        relic1.setImageResource(getImage("nike_relic1"));
        relic2.setImageResource(getImage("nike_relic2"));
        item1.setImageResource(getImage("nike_item1"));
        item2.setImageResource(getImage("nike_item2"));
        item3.setImageResource(getImage("nike_item3"));
        item4.setImageResource(getImage("nike_item4"));
        item5.setImageResource(getImage("nike_item5"));
        item6.setImageResource(getImage("nike_item6"));

        //Loading build names
        starterName.setText(getName("nike_starter_name"));
        relic1Name.setText(getName("nike_relic1_name"));
        relic2Name.setText(getName("nike_relic2_name"));
        item1Name.setText(getName("nike_item1_name"));
        item2Name.setText(getName("nike_item2_name"));
        item3Name.setText(getName("nike_item3_name"));
        item4Name.setText(getName("nike_item4_name"));
        item5Name.setText(getName("nike_item5_name"));
        item6Name.setText(getName("nike_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_starter_name", name);
                        saveImage("nike_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_relic1_name", name);
                        saveImage("nike_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_relic2_name", name);
                        saveImage("nike_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_item1_name", name);
                        saveImage("nike_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_item2_name", name);
                        saveImage("nike_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_item3_name", name);
                        saveImage("nike_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_item4_name", name);
                        saveImage("nike_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_item5_name", name);
                        saveImage("nike_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nike_item6_name", name);
                        saveImage("nike_item6", resourceId);
