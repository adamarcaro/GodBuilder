...
public class TabFragmentZeus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.zeus);
        godName.setText(R.string.zeus);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.zeus_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentZeus1();
                case 1 : return new FragmentZeus2();
                case 2 : return new FragmentZeus3();
            }
            return null;
        }
