...
public class FragmentRama extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_rama, container, false);
        ...
        starter.setImageResource(getImage("rama_starter"));
        relic1.setImageResource(getImage("rama_relic1"));
        relic2.setImageResource(getImage("rama_relic2"));
        item1.setImageResource(getImage("rama_item1"));
        item2.setImageResource(getImage("rama_item2"));
        item3.setImageResource(getImage("rama_item3"));
        item4.setImageResource(getImage("rama_item4"));
        item5.setImageResource(getImage("rama_item5"));
        item6.setImageResource(getImage("rama_item6"));

        //Loading build names
        starterName.setText(getName("rama_starter_name"));
        relic1Name.setText(getName("rama_relic1_name"));
        relic2Name.setText(getName("rama_relic2_name"));
        item1Name.setText(getName("rama_item1_name"));
        item2Name.setText(getName("rama_item2_name"));
        item3Name.setText(getName("rama_item3_name"));
        item4Name.setText(getName("rama_item4_name"));
        item5Name.setText(getName("rama_item5_name"));
        item6Name.setText(getName("rama_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_starter_name", name);
                        saveImage("rama_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_relic1_name", name);
                        saveImage("rama_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_relic2_name", name);
                        saveImage("rama_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item1_name", name);
                        saveImage("rama_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item2_name", name);
                        saveImage("rama_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item3_name", name);
                        saveImage("rama_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item4_name", name);
                        saveImage("rama_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item5_name", name);
                        saveImage("rama_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item6_name", name);
                        saveImage("rama_item6", resourceId);
