...
public class TabFragmentMercury extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.mercury);
        godName.setText(R.string.mercury);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_roman,0);
        godTitle.setText(R.string.mercury_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentMercury1();
                case 1 : return new FragmentMercury2();
                case 2 : return new FragmentMercury3();
            }
            return null;
        }
