...
public class FragmentAwilix extends Fragment {

    View myView;

    public FragmentAwilix() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_awilix, container, false);
        ...
        starter.setImageResource(getImage("awilix_starter"));
        relic1.setImageResource(getImage("awilix_relic1"));
        relic2.setImageResource(getImage("awilix_relic2"));
        item1.setImageResource(getImage("awilix_item1"));
        item2.setImageResource(getImage("awilix_item2"));
        item3.setImageResource(getImage("awilix_item3"));
        item4.setImageResource(getImage("awilix_item4"));
        item5.setImageResource(getImage("awilix_item5"));
        item6.setImageResource(getImage("awilix_item6"));

        //Loading build names
        starterName.setText(getName("awilix_starter_name"));
        relic1Name.setText(getName("awilix_relic1_name"));
        relic2Name.setText(getName("awilix_relic2_name"));
        item1Name.setText(getName("awilix_item1_name"));
        item2Name.setText(getName("awilix_item2_name"));
        item3Name.setText(getName("awilix_item3_name"));
        item4Name.setText(getName("awilix_item4_name"));
        item5Name.setText(getName("awilix_item5_name"));
        item6Name.setText(getName("awilix_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_starter_name", name);
                        saveImage("awilix_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_relic1_name", name);
                        saveImage("awilix_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_relic2_name", name);
                        saveImage("awilix_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_item1_name", name);
                        saveImage("awilix_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_item2_name", name);
                        saveImage("awilix_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_item3_name", name);
                        saveImage("awilix_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_item4_name", name);
                        saveImage("awilix_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_item5_name", name);
                        saveImage("awilix_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("awilix_item6_name", name);
                        saveImage("awilix_item6", resourceId);
