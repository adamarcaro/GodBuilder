...
public class TabFragmentCamazotz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.camazotz);
        godName.setText(R.string.camazotz);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_mayan,0);
        godTitle.setText(R.string.camazots_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentCamazotz1();
                case 1 : return new FragmentCamazotz2();
                case 2 : return new FragmentCamazotz3();
            }
            return null;
        }
