...
public class TabFragmentAhPuch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.ah_puch);
        godName.setText(R.string.ah_puch);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_mayan,0);
        godTitle.setText(R.string.ah_puch_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentAhPuch1();
                case 1 : return new FragmentAhPuch2();
                case 2 : return new FragmentAhPuch3();
            }
            return null;
        }
