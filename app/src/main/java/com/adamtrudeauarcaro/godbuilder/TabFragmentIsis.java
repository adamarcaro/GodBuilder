...
public class TabFragmentIsis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.isis);
        godName.setText(R.string.isis);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.isis_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentIsis1();
                case 1 : return new FragmentIsis2();
                case 2 : return new FragmentIsis3();
            }
            return null;
        }
