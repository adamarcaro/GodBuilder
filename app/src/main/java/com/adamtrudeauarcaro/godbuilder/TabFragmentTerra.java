...
public class TabFragmentTerra extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.terra);
        godName.setText(R.string.terra);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_roman,0);
        godTitle.setText(R.string.terra_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentTerra1();
                case 1 : return new FragmentTerra2();
                case 2 : return new FragmentTerra3();
            }
            return null;
        }
