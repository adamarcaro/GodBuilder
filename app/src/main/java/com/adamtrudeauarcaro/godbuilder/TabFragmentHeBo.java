...
public class TabFragmentHeBo extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.he_bo);
        godName.setText(R.string.he_bo);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.he_bo_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentHeBo1();
                case 1 : return new FragmentHeBo2();
                case 2 : return new FragmentHeBo3();
            }
            return null;
        }
