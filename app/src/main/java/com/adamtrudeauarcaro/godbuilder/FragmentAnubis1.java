...
public class FragmentAnubis1 extends Fragment {

    View myView;

    public FragmentAnubis1() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        starter.setImageResource(getImage("anubis_starter"));
        relic1.setImageResource(getImage("anubis_relic1"));
        relic2.setImageResource(getImage("anubis_relic2"));
        item1.setImageResource(getImage("anubis_item1"));
        item2.setImageResource(getImage("anubis_item2"));
        item3.setImageResource(getImage("anubis_item3"));
        item4.setImageResource(getImage("anubis_item4"));
        item5.setImageResource(getImage("anubis_item5"));
        item6.setImageResource(getImage("anubis_item6"));

        //Loading build names
        starterName.setText(getName("anubis_starter_name"));
        relic1Name.setText(getName("anubis_relic1_name"));
        relic2Name.setText(getName("anubis_relic2_name"));
        item1Name.setText(getName("anubis_item1_name"));
        item2Name.setText(getName("anubis_item2_name"));
        item3Name.setText(getName("anubis_item3_name"));
        item4Name.setText(getName("anubis_item4_name"));
        item5Name.setText(getName("anubis_item5_name"));
        item6Name.setText(getName("anubis_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_starter_name", name);
                        saveImage("anubis_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_relic1_name", name);
                        saveImage("anubis_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_relic2_name", name);
                        saveImage("anubis_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_item1_name", name);
                        saveImage("anubis_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_item2_name", name);
                        saveImage("anubis_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_item3_name", name);
                        saveImage("anubis_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_item4_name", name);
                        saveImage("anubis_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_item5_name", name);
                        saveImage("anubis_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("anubis_item6_name", name);
                        saveImage("anubis_item6", resourceId);
