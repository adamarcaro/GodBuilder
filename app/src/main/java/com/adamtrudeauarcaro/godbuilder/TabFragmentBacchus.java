...
public class TabFragmentBacchus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.bacchus);
        godName.setText(R.string.bacchus);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_roman,0);
        godTitle.setText(R.string.bacchus_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentBacchus1();
                case 1 : return new FragmentBacchus2();
                case 2 : return new FragmentBacchus3();
            }
            return null;
        }
