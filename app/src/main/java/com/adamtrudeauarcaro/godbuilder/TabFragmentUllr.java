...
public class TabFragmentUllr extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.ullr);
        godName.setText(R.string.ullr);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.ullr_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentUllr1();
                case 1 : return new FragmentUllr2();
                case 2 : return new FragmentUllr3();
            }
            return null;
        }
