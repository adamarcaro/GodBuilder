...
public class FragmentMercury extends Fragment {
    ...
    public FragmentMercury() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_mercury, container, false);
        ...
        starter.setImageResource(getImage("mercury_starter"));
        relic1.setImageResource(getImage("mercury_relic1"));
        relic2.setImageResource(getImage("mercury_relic2"));
        item1.setImageResource(getImage("mercury_item1"));
        item2.setImageResource(getImage("mercury_item2"));
        item3.setImageResource(getImage("mercury_item3"));
        item4.setImageResource(getImage("mercury_item4"));
        item5.setImageResource(getImage("mercury_item5"));
        item6.setImageResource(getImage("mercury_item6"));

        //Loading build names
        starterName.setText(getName("mercury_starter_name"));
        relic1Name.setText(getName("mercury_relic1_name"));
        relic2Name.setText(getName("mercury_relic2_name"));
        item1Name.setText(getName("mercury_item1_name"));
        item2Name.setText(getName("mercury_item2_name"));
        item3Name.setText(getName("mercury_item3_name"));
        item4Name.setText(getName("mercury_item4_name"));
        item5Name.setText(getName("mercury_item5_name"));
        item6Name.setText(getName("mercury_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_starter_name", name);
                        saveImage("mercury_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_relic1_name", name);
                        saveImage("mercury_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_relic2_name", name);
                        saveImage("mercury_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_item1_name", name);
                        saveImage("mercury_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_item2_name", name);
                        saveImage("mercury_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_item3_name", name);
                        saveImage("mercury_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_item4_name", name);
                        saveImage("mercury_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_item5_name", name);
                        saveImage("mercury_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("mercury_item6_name", name);
                        saveImage("mercury_item6", resourceId);
