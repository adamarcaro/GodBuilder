...
public class TabFragmentKukulkan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.kukulkan);
        godName.setText(R.string.kukulkan);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_mayan,0);
        godTitle.setText(R.string.kukulkan_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentKukulkan1();
                case 1 : return new FragmentKukulkan2();
                case 2 : return new FragmentKukulkan3();
            }
            return null;
        }
