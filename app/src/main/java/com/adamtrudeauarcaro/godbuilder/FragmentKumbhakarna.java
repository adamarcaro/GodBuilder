...
public class FragmentKumbhakarna extends Fragment {

    View myView;

    public FragmentKumbhakarna() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_kumbhakarna, container, false);
        ...
        starter.setImageResource(getImage("kumbhakarna_starter"));
        relic1.setImageResource(getImage("kumbhakarna_relic1"));
        relic2.setImageResource(getImage("kumbhakarna_relic2"));
        item1.setImageResource(getImage("kumbhakarna_item1"));
        item2.setImageResource(getImage("kumbhakarna_item2"));
        item3.setImageResource(getImage("kumbhakarna_item3"));
        item4.setImageResource(getImage("kumbhakarna_item4"));
        item5.setImageResource(getImage("kumbhakarna_item5"));
        item6.setImageResource(getImage("kumbhakarna_item6"));

        //Loading build names
        starterName.setText(getName("kumbhakarna_starter_name"));
        relic1Name.setText(getName("kumbhakarna_relic1_name"));
        relic2Name.setText(getName("kumbhakarna_relic2_name"));
        item1Name.setText(getName("kumbhakarna_item1_name"));
        item2Name.setText(getName("kumbhakarna_item2_name"));
        item3Name.setText(getName("kumbhakarna_item3_name"));
        item4Name.setText(getName("kumbhakarna_item4_name"));
        item5Name.setText(getName("kumbhakarna_item5_name"));
        item6Name.setText(getName("kumbhakarna_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_starter_name", name);
                        saveImage("kumbhakarna_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_relic1_name", name);
                        saveImage("kumbhakarna_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_relic2_name", name);
                        saveImage("kumbhakarna_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_item1_name", name);
                        saveImage("kumbhakarna_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_item2_name", name);
                        saveImage("kumbhakarna_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_item3_name", name);
                        saveImage("kumbhakarna_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_item4_name", name);
                        saveImage("kumbhakarna_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_item5_name", name);
                        saveImage("kumbhakarna_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kumbhakarna_item6_name", name);
                        saveImage("kumbhakarna_item6", resourceId);
