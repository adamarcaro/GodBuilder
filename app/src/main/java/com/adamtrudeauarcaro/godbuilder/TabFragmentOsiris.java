...
public class TabFragmentOsiris extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.osiris);
        godName.setText(R.string.osiris);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.osiris_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentOsiris1();
                case 1 : return new FragmentOsiris2();
                case 2 : return new FragmentOsiris3();
            }
            return null;
        }
