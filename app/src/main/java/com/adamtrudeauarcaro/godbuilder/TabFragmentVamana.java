...
public class TabFragmentVamana extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.vamana);
        godName.setText(R.string.vamana);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_hindu,0);
        godTitle.setText(R.string.vamana_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentVamana1();
                case 1 : return new FragmentVamana2();
                case 2 : return new FragmentVamana3();
            }
            return null;
        }
