...
public class TabFragmentThoth extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.thoth);
        godName.setText(R.string.thoth);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.thoth_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentThoth1();
                case 1 : return new FragmentThoth2();
                case 2 : return new FragmentThoth3();
            }
            return null;
        }
