...
public class TabFragmentNeith extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.neith);
        godName.setText(R.string.neith);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.neith_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentNeith1();
                case 1 : return new FragmentNeith2();
                case 2 : return new FragmentNeith3();
            }
            return null;
        }
