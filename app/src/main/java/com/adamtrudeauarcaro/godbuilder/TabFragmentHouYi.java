...
public class TabFragmentHouYi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.hou_yi);
        godName.setText(R.string.hou_yi);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.hou_yi_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentHouYi1();
                case 1 : return new FragmentHouYi2();
                case 2 : return new FragmentHouYi3();
            }
            return null;
        }
