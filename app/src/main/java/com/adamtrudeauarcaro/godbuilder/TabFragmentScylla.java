...
public class TabFragmentScylla extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.scylla);
        godName.setText(R.string.scylla);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.scylla_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentScylla1();
                case 1 : return new FragmentScylla2();
                case 2 : return new FragmentScylla3();
            }
            return null;
        }
