...
public class TabFragmentSobek extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.sobek);
        godName.setText(R.string.sobek);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.sobek_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentSobek1();
                case 1 : return new FragmentSobek2();
                case 2 : return new FragmentSobek3();
            }
            return null;
        }
