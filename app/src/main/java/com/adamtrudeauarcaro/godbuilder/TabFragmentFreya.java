...
public class TabFragmentFreya extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.freya);
        godName.setText(R.string.freya);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.freya_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentFreya1();
                case 1 : return new FragmentFreya2();
                case 2 : return new FragmentFreya3();
            }
            return null;
        }
