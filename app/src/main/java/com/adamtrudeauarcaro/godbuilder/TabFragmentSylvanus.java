...
public class TabFragmentSylvanus extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.sylvanus);
        godName.setText(R.string.sylvanus);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_roman,0);
        godTitle.setText(R.string.sylvanus_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentSylvanus1();
                case 1 : return new FragmentSylvanus2();
                case 2 : return new FragmentSylvanus3();
            }
            return null;
        }
