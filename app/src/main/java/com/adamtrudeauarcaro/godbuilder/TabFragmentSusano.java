...
public class TabFragmentSusano extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.susano);
        godName.setText(R.string.susano);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_japanese,0);
        godTitle.setText(R.string.susano_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentSusano1();
                case 1 : return new FragmentSusano2();
                case 2 : return new FragmentSusano3();
            }
            return null;
        }
