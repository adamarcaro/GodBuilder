...
public class FragmentRama3 extends Fragment {

    View myView;

    public FragmentRama3() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        starter.setImageResource(getImage("rama_starter_3"));
        relic1.setImageResource(getImage("rama_relic1_3"));
        relic2.setImageResource(getImage("rama_relic2_3"));
        item1.setImageResource(getImage("rama_item1_3"));
        item2.setImageResource(getImage("rama_item2_3"));
        item3.setImageResource(getImage("rama_item3_3"));
        item4.setImageResource(getImage("rama_item4_3"));
        item5.setImageResource(getImage("rama_item5_3"));
        item6.setImageResource(getImage("rama_item6_3"));

        //Loading build names
        starterName.setText(getName("rama_starter_name_3"));
        relic1Name.setText(getName("rama_relic1_name_3"));
        relic2Name.setText(getName("rama_relic2_name_3"));
        item1Name.setText(getName("rama_item1_name_3"));
        item2Name.setText(getName("rama_item2_name_3"));
        item3Name.setText(getName("rama_item3_name_3"));
        item4Name.setText(getName("rama_item4_name_3"));
        item5Name.setText(getName("rama_item5_name_3"));
        item6Name.setText(getName("rama_item6_name_3"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_starter_name_3", name);
                        saveImage("rama_starter_3", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_relic1_name_3", name);
                        saveImage("rama_relic1_3", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_relic2_name_3", name);
                        saveImage("rama_relic2_3", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item1_name_3", name);
                        saveImage("rama_item1_3", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item2_name_3", name);
                        saveImage("rama_item2_3", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item3_name_3", name);
                        saveImage("rama_item3_3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item4_name_3", name);
                        saveImage("rama_item4_3", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item5_name_3", name);
                        saveImage("rama_item5_3", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("rama_item6_name_3", name);
                        saveImage("rama_item6_3", resourceId);
