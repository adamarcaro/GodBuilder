...
public class FragmentMedusa extends Fragment {

    View myView;

    public FragmentMedusa() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_medusa, container, false);
        ...
        starter.setImageResource(getImage("medusa_starter"));
        relic1.setImageResource(getImage("medusa_relic1"));
        relic2.setImageResource(getImage("medusa_relic2"));
        item1.setImageResource(getImage("medusa_item1"));
        item2.setImageResource(getImage("medusa_item2"));
        item3.setImageResource(getImage("medusa_item3"));
        item4.setImageResource(getImage("medusa_item4"));
        item5.setImageResource(getImage("medusa_item5"));
        item6.setImageResource(getImage("medusa_item6"));

        //Loading build names
        starterName.setText(getName("medusa_starter_name"));
        relic1Name.setText(getName("medusa_relic1_name"));
        relic2Name.setText(getName("medusa_relic2_name"));
        item1Name.setText(getName("medusa_item1_name"));
        item2Name.setText(getName("medusa_item2_name"));
        item3Name.setText(getName("medusa_item3_name"));
        item4Name.setText(getName("medusa_item4_name"));
        item5Name.setText(getName("medusa_item5_name"));
        item6Name.setText(getName("medusa_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_starter_name", name);
                        saveImage("medusa_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_relic1_name", name);
                        saveImage("medusa_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_relic2_name", name);
                        saveImage("medusa_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item1_name", name);
                        saveImage("medusa_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item2_name", name);
                        saveImage("medusa_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item3_name", name);
                        saveImage("medusa_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item4_name", name);
                        saveImage("medusa_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item5_name", name);
                        saveImage("medusa_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item6_name", name);
                        saveImage("medusa_item6", resourceId);
