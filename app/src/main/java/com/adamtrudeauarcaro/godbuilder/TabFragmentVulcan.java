...
public class TabFragmentVulcan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.vulcan);
        godName.setText(R.string.vulcan);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_roman,0);
        godTitle.setText(R.string.vulcan_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentVulcan1();
                case 1 : return new FragmentVulcan2();
                case 2 : return new FragmentVulcan3();
            }
            return null;
        }
