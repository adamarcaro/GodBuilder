...
public class TabFragmentHercules extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.hercules);
        godName.setText(R.string.hercules);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_roman,0);
        godTitle.setText(R.string.hercules_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentHercules1();
                case 1 : return new FragmentHercules2();
                case 2 : return new FragmentHercules3();
            }
            return null;
        }
