...
public class TabFragmentYmir extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.ymir);
        godName.setText(R.string.ymir);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.ymir_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentYmir1();
                case 1 : return new FragmentYmir2();
                case 2 : return new FragmentYmir3();
            }
            return null;
        }
