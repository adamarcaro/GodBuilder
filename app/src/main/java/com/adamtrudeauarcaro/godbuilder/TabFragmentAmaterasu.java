...
public class TabFragmentAmaterasu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.amaterasu);
        godName.setText(R.string.amaterasu);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_japanese,0);
        godTitle.setText(R.string.amaterasu_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentAmaterasu1();
                case 1 : return new FragmentAmaterasu2();
                case 2 : return new FragmentAmaterasu3();
            }
            return null;
        }
