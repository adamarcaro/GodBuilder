...
public class TabFragmentAnhur extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.anhur);
        godName.setText(R.string.anhur);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.anhur_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentAnhur1();
                case 1 : return new FragmentAnhur2();
                case 2 : return new FragmentAnhur3();
            }
            return null;
        }
