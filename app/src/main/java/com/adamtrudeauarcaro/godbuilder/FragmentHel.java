...
public class FragmentHel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_hel, container, false);
        ...
        starter.setImageResource(getImage("hel_starter"));
        relic1.setImageResource(getImage("hel_relic1"));
        relic2.setImageResource(getImage("hel_relic2"));
        item1.setImageResource(getImage("hel_item1"));
        item2.setImageResource(getImage("hel_item2"));
        item3.setImageResource(getImage("hel_item3"));
        item4.setImageResource(getImage("hel_item4"));
        item5.setImageResource(getImage("hel_item5"));
        item6.setImageResource(getImage("hel_item6"));

        //Loading build names
        starterName.setText(getName("hel_starter_name"));
        relic1Name.setText(getName("hel_relic1_name"));
        relic2Name.setText(getName("hel_relic2_name"));
        item1Name.setText(getName("hel_item1_name"));
        item2Name.setText(getName("hel_item2_name"));
        item3Name.setText(getName("hel_item3_name"));
        item4Name.setText(getName("hel_item4_name"));
        item5Name.setText(getName("hel_item5_name"));
        item6Name.setText(getName("hel_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_starter_name", name);
                        saveImage("hel_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_relic1_name", name);
                        saveImage("hel_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_relic2_name", name);
                        saveImage("hel_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_item1_name", name);
                        saveImage("hel_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_item2_name", name);
                        saveImage("hel_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_item3_name", name);
                        saveImage("hel_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_item4_name", name);
                        saveImage("hel_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_item5_name", name);
                        saveImage("hel_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("hel_item6_name", name);
                        saveImage("hel_item6", resourceId);
