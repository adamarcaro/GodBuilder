...
public class TabFragmentBastet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.bastet);
        godName.setText(R.string.bastet);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.bastet_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentBastet1();
                case 1 : return new FragmentBastet2();
                case 2 : return new FragmentBastet3();
            }
            return null;
        }
