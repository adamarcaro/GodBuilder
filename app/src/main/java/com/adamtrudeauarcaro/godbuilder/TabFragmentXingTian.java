...
public class TabFragmentXingTian extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.xing_tian);
        godName.setText(R.string.xing_tian);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.xing_tian_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentXingTian1();
                case 1 : return new FragmentXingTian2();
                case 2 : return new FragmentXingTian3();
            }
            return null;
        }
