...
public class ItemMagStarterFragment1 extends DialogFragment {
    ...
    public static ItemMagStarterFragment1 newInstance()
    {
        ItemMagStarterFragment1 f = new ItemMagStarterFragment1();
        return f;
    }
