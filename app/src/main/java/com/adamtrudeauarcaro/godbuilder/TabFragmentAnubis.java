...
public class TabFragmentAnubis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.anubis);
        godName.setText(R.string.anubis);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.anubis_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentAnubis1();
                case 1 : return new FragmentAnubis2();
                case 2 : return new FragmentAnubis3();
            }
            return null;
        }
