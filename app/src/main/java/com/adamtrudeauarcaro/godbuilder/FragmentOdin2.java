...
public class FragmentOdin2 extends Fragment {

    View myView;

    public FragmentOdin2() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        starter.setImageResource(getImage("odin_starter_2"));
        relic1.setImageResource(getImage("odin_relic1_2"));
        relic2.setImageResource(getImage("odin_relic2_2"));
        item1.setImageResource(getImage("odin_item1_2"));
        item2.setImageResource(getImage("odin_item2_2"));
        item3.setImageResource(getImage("odin_item3_2"));
        item4.setImageResource(getImage("odin_item4_2"));
        item5.setImageResource(getImage("odin_item5_2"));
        item6.setImageResource(getImage("odin_item6_2"));

        //Loading build names
        starterName.setText(getName("odin_starter_name_2"));
        relic1Name.setText(getName("odin_relic1_name_2"));
        relic2Name.setText(getName("odin_relic2_name_2"));
        item1Name.setText(getName("odin_item1_name_2"));
        item2Name.setText(getName("odin_item2_name_2"));
        item3Name.setText(getName("odin_item3_name_2"));
        item4Name.setText(getName("odin_item4_name_2"));
        item5Name.setText(getName("odin_item5_name_2"));
        item6Name.setText(getName("odin_item6_name_2"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_starter_name_2", name);
                        saveImage("odin_starter_2", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_relic1_name_2", name);
                        saveImage("odin_relic1_2", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_relic2_name_2", name);
                        saveImage("odin_relic2_2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item1_name_2", name);
                        saveImage("odin_item1_2", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item2_name_2", name);
                        saveImage("odin_item2_2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item3_name_2", name);
                        saveImage("odin_item3_2", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item4_name_2", name);
                        saveImage("odin_item4_2", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item5_name_2", name);
                        saveImage("odin_item5_2", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("odin_item6_name_2", name);
                        saveImage("odin_item6_2", resourceId);
