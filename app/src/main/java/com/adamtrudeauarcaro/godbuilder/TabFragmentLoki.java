...
public class TabFragmentLoki extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.loki);
        godName.setText(R.string.loki);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.loki_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentLoki1();
                case 1 : return new FragmentLoki2();
                case 2 : return new FragmentLoki3();
            }
            return null;
        }
