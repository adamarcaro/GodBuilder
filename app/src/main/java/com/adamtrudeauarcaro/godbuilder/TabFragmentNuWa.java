...
public class TabFragmentNuWa extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.nu_wa);
        godName.setText(R.string.nu_wa);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.nu_wa_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentNuWa1();
                case 1 : return new FragmentNuWa2();
                case 2 : return new FragmentNuWa3();
            }
            return null;
        }
