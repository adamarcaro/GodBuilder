...
public class TabFragmentMedusa extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.medusa);
        godName.setText(R.string.medusa);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.medusa_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentMedusa1();
                case 1 : return new FragmentMedusa2();
                case 2 : return new FragmentMedusa3();
            }
            return null;
        }
