...
public class TabFragmentChronos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.chronos);
        godName.setText(R.string.chronos);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.chronos_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentChronos1();
                case 1 : return new FragmentChronos2();
                case 2 : return new FragmentChronos3();
            }
            return null;
        }
