...
public class TabFragmentAoKuang extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.ao_kuang);
        godName.setText(R.string.ao_kuang);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.ao_kuang_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentAoKuang1();
                case 1 : return new FragmentAoKuang2();
                case 2 : return new FragmentAoKuang3();
            }
            return null;
        }
