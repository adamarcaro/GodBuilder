...
public class TabFragmentThanatos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.thanatos);
        godName.setText(R.string.thanatos);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.thanatos_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentThanatos1();
                case 1 : return new FragmentThanatos2();
                case 2 : return new FragmentThanatos3();
            }
            return null;
        }
