...
public class TabFragmentIzanami extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.izanami);
        godName.setText(R.string.izanami);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_japanese,0);
        godTitle.setText(R.string.izanami_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentIzanami1();
                case 1 : return new FragmentIzanami2();
                case 2 : return new FragmentIzanami3();
            }
            return null;
        }
