...
public class TabFragmentRaijin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.raijin);
        godName.setText(R.string.raijin);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_japanese,0);
        godTitle.setText(R.string.raijin_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentRaijin1();
                case 1 : return new FragmentRaijin2();
                case 2 : return new FragmentRaijin3();
            }
            return null;
        }
