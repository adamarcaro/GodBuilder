...
public class FragmentBastet extends Fragment {

    View myView;

    public FragmentBastet() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_bastet, container, false);
        ...
        starter.setImageResource(getImage("bastet_starter"));
        relic1.setImageResource(getImage("bastet_relic1"));
        relic2.setImageResource(getImage("bastet_relic2"));
        item1.setImageResource(getImage("bastet_item1"));
        item2.setImageResource(getImage("bastet_item2"));
        item3.setImageResource(getImage("bastet_item3"));
        item4.setImageResource(getImage("bastet_item4"));
        item5.setImageResource(getImage("bastet_item5"));
        item6.setImageResource(getImage("bastet_item6"));

        //Loading build names
        starterName.setText(getName("bastet_starter_name"));
        relic1Name.setText(getName("bastet_relic1_name"));
        relic2Name.setText(getName("bastet_relic2_name"));
        item1Name.setText(getName("bastet_item1_name"));
        item2Name.setText(getName("bastet_item2_name"));
        item3Name.setText(getName("bastet_item3_name"));
        item4Name.setText(getName("bastet_item4_name"));
        item5Name.setText(getName("bastet_item5_name"));
        item6Name.setText(getName("bastet_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_starter_name", name);
                        saveImage("bastet_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_relic1_name", name);
                        saveImage("bastet_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_relic2_name", name);
                        saveImage("bastet_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_item1_name", name);
                        saveImage("bastet_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_item2_name", name);
                        saveImage("bastet_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_item3_name", name);
                        saveImage("bastet_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_item4_name", name);
                        saveImage("bastet_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_item5_name", name);
                        saveImage("bastet_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("bastet_item6_name", name);
                        saveImage("bastet_item6", resourceId);
