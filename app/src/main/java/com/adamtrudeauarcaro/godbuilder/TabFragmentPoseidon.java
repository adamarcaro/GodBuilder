...
public class TabFragmentPoseidon extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.poseidon);
        godName.setText(R.string.poseidon);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.poseidon_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentPoseidon1();
                case 1 : return new FragmentPoseidon2();
                case 2 : return new FragmentPoseidon3();
            }
            return null;
        }
