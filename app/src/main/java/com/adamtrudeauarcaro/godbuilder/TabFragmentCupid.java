...
public class TabFragmentCupid extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.cupid);
        godName.setText(R.string.cupid);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_roman,0);
        godTitle.setText(R.string.cupid_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentCupid1();
                case 1 : return new FragmentCupid2();
                case 2 : return new FragmentCupid3();
            }
            return null;
        }
