...
public class TabFragmentChaac extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.chaac);
        godName.setText(R.string.chaac);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_mayan,0);
        godTitle.setText(R.string.chaac_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentChaac1();
                case 1 : return new FragmentChaac2();
                case 2 : return new FragmentChaac3();
            }
            return null;
        }
