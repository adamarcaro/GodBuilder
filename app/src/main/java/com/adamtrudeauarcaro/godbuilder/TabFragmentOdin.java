...
public class TabFragmentOdin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.odin);
        godName.setText(R.string.odin);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.odin_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentOdin1();
                case 1 : return new FragmentOdin2();
                case 2 : return new FragmentOdin3();
            }
            return null;
        }
