...
public class TabFragmentFenrir extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.fenrir);
        godName.setText(R.string.fenrir);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.fenrir_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentFenrir1();
                case 1 : return new FragmentFenrir2();
                case 2 : return new FragmentFenrir3();
            }
            return null;
        }
