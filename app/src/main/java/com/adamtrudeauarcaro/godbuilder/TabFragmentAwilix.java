...
public class TabFragmentAwilix extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.awilix);
        godName.setText(R.string.awilix);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_mayan,0);
        godTitle.setText(R.string.awilix_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentAwilix1();
                case 1 : return new FragmentAwilix2();
                case 2 : return new FragmentAwilix3();
            }
            return null;
        }
