...
public class TabFragmentNeZha extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.ne_zha);
        godName.setText(R.string.ne_zha);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.ne_zha_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentNeZha1();
                case 1 : return new FragmentNeZha2();
                case 2 : return new FragmentNeZha3();
            }
            return null;
        }
