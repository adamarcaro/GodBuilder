...
public class TabFragmentHunBatz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.hun_batz);
        godName.setText(R.string.hun_batz);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_mayan,0);
        godTitle.setText(R.string.hun_batz_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentHunBatz1();
                case 1 : return new FragmentHunBatz2();
                case 2 : return new FragmentHunBatz3();
            }
            return null;
        }
