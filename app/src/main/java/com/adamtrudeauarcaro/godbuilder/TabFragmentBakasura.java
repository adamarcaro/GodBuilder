...
public class TabFragmentBakasura extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.bakasura);
        godName.setText(R.string.bakasura);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_hindu,0);
        godTitle.setText(R.string.bakasura_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentBakasura1();
                case 1 : return new FragmentBakasura2();
                case 2 : return new FragmentBakasura3();
            }
            return null;
        }
