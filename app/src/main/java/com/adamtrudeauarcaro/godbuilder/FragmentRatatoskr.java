...
public class FragmentRatatoskr extends Fragment {

    View myView;

    public FragmentRatatoskr() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_ratatoskr, container, false);
        ...
        starter.setImageResource(getImage("ratatoskr_starter"));
        relic1.setImageResource(getImage("ratatoskr_relic1"));
        relic2.setImageResource(getImage("ratatoskr_relic2"));
        item1.setImageResource(R.drawable.acorn);
        item2.setImageResource(getImage("ratatoskr_item2"));
        item3.setImageResource(getImage("ratatoskr_item3"));
        item4.setImageResource(getImage("ratatoskr_item4"));
        item5.setImageResource(getImage("ratatoskr_item5"));
        item6.setImageResource(getImage("ratatoskr_item6"));

        //Loading build names
        starterName.setText(getName("ratatoskr_starter_name"));
        relic1Name.setText(getName("ratatoskr_relic1_name"));
        relic2Name.setText(getName("ratatoskr_relic2_name"));
        item1Name.setText("Acorn of Yggdrasil");
        item2Name.setText(getName("ratatoskr_item2_name"));
        item3Name.setText(getName("ratatoskr_item3_name"));
        item4Name.setText(getName("ratatoskr_item4_name"));
        item5Name.setText(getName("ratatoskr_item5_name"));
        item6Name.setText(getName("ratatoskr_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_starter_name", name);
                        saveImage("ratatoskr_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_relic1_name", name);
                        saveImage("ratatoskr_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_relic2_name", name);
                        saveImage("ratatoskr_relic2", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                ItemRatFragment dialog = ItemRatFragment.newInstance();
                dialog.setOnListItemSelectedListener(new ItemRatFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_item2_name", name);
                        saveImage("ratatoskr_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRatFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_item3_name", name);
                        saveImage("ratatoskr_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRatFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_item4_name", name);
                        saveImage("ratatoskr_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRatFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_item5_name", name);
                        saveImage("ratatoskr_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRatFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_item6_name", name);
                        saveImage("ratatoskr_item6", resourceId);
