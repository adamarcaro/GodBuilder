...
public class TabFragmentRavana extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.ravana);
        godName.setText(R.string.ravana);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_hindu,0);
        godTitle.setText(R.string.ravana_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentRavana1();
                case 1 : return new FragmentRavana2();
                case 2 : return new FragmentRavana3();
            }
            return null;
        }
