...
public class TabFragmentTheMorrigan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.the_morrigan);
        godName.setText(R.string.the_morrigan);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_celtic,0);
        godTitle.setText(R.string.the_morrigan_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentTheMorrigan1();
                case 1 : return new FragmentTheMorrigan2();
                case 2 : return new FragmentTheMorrigan3();
            }
            return null;
        }
