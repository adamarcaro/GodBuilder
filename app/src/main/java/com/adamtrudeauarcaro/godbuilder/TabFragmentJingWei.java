...
public class TabFragmentJingWei extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.jing_wei);
        godName.setText(R.string.jing_wei);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.jing_wei_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentJingWei1();
                case 1 : return new FragmentJingWei2();
                case 2 : return new FragmentJingWei3();
            }
            return null;
        }
