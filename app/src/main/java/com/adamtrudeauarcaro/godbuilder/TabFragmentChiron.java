...
public class TabFragmentChiron extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.chiron);
        godName.setText(R.string.chiron);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.chiron_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentChiron1();
                case 1 : return new FragmentChiron2();
                case 2 : return new FragmentChiron3();
            }
            return null;
        }
