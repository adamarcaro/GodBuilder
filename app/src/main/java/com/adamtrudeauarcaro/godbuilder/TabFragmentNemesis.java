...
public class TabFragmentNemesis extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.nemesis);
        godName.setText(R.string.nemesis);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.nemesis_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentNemesis1();
                case 1 : return new FragmentNemesis2();
                case 2 : return new FragmentNemesis3();
            }
            return null;
        }
