...
public class TabFragmentAphrodite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.aphrodite);
        godName.setText(R.string.aphrodite);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_greek,0);
        godTitle.setText(R.string.aphrodite_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentAphrodite1();
                case 1 : return new FragmentAphrodite2();
                case 2 : return new FragmentAphrodite3();
            }
            return null;
        }
