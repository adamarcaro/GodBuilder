...
public class TabFragmentSunWukong extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.sun_wukong);
        godName.setText(R.string.sun_wukong);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.sun_wukong_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentSunWukong1();
                case 1 : return new FragmentSunWukong2();
                case 2 : return new FragmentSunWukong3();
            }
            return null;
        }
