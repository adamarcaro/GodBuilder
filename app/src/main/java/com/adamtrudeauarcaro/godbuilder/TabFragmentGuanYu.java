...
public class TabFragmentGuanYu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.guan_yu);
        godName.setText(R.string.guan_yu);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.guan_yu_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentGuanYu1();
                case 1 : return new FragmentGuanYu2();
                case 2 : return new FragmentGuanYu3();
            }
            return null;
        }
