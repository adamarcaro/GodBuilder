...
public class TabFragmentBellona extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.bellona);
        godName.setText(R.string.bellona);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_roman,0);
        godTitle.setText(R.string.bellona_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentBellona1();
                case 1 : return new FragmentBellona2();
                case 2 : return new FragmentBellona3();
            }
            return null;
        }
