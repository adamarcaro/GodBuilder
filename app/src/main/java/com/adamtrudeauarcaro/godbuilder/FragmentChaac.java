...
public class FragmentChaac extends Fragment {

    View myView;

    public FragmentChaac() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_chaac, container, false);
        ...
        starter.setImageResource(getImage("chaac_starter"));
        relic1.setImageResource(getImage("chaac_relic1"));
        relic2.setImageResource(getImage("chaac_relic2"));
        item1.setImageResource(getImage("chaac_item1"));
        item2.setImageResource(getImage("chaac_item2"));
        item3.setImageResource(getImage("chaac_item3"));
        item4.setImageResource(getImage("chaac_item4"));
        item5.setImageResource(getImage("chaac_item5"));
        item6.setImageResource(getImage("chaac_item6"));

        //Loading build names
        starterName.setText(getName("chaac_starter_name"));
        relic1Name.setText(getName("chaac_relic1_name"));
        relic2Name.setText(getName("chaac_relic2_name"));
        item1Name.setText(getName("chaac_item1_name"));
        item2Name.setText(getName("chaac_item2_name"));
        item3Name.setText(getName("chaac_item3_name"));
        item4Name.setText(getName("chaac_item4_name"));
        item5Name.setText(getName("chaac_item5_name"));
        item6Name.setText(getName("chaac_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_starter_name", name);
                        saveImage("chaac_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_relic1_name", name);
                        saveImage("chaac_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_relic2_name", name);
                        saveImage("chaac_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_item1_name", name);
                        saveImage("chaac_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_item2_name", name);
                        saveImage("chaac_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_item3_name", name);
                        saveImage("chaac_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_item4_name", name);
                        saveImage("chaac_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_item5_name", name);
                        saveImage("chaac_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("chaac_item6_name", name);
                        saveImage("chaac_item6", resourceId);
