...
public class TabFragmentSerqet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.serqet);
        godName.setText(R.string.serqet);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.serqet_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentSerqet1();
                case 1 : return new FragmentSerqet2();
                case 2 : return new FragmentSerqet3();
            }
            return null;
        }
