...
public class FragmentNemesis extends Fragment {

    View myView;

    public FragmentNemesis() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_nemesis, container, false);
        ...
        starter.setImageResource(getImage("nemesis_starter"));
        relic1.setImageResource(getImage("nemesis_relic1"));
        relic2.setImageResource(getImage("nemesis_relic2"));
        item1.setImageResource(getImage("nemesis_item1"));
        item2.setImageResource(getImage("nemesis_item2"));
        item3.setImageResource(getImage("nemesis_item3"));
        item4.setImageResource(getImage("nemesis_item4"));
        item5.setImageResource(getImage("nemesis_item5"));
        item6.setImageResource(getImage("nemesis_item6"));

        //Loading build names
        starterName.setText(getName("nemesis_starter_name"));
        relic1Name.setText(getName("nemesis_relic1_name"));
        relic2Name.setText(getName("nemesis_relic2_name"));
        item1Name.setText(getName("nemesis_item1_name"));
        item2Name.setText(getName("nemesis_item2_name"));
        item3Name.setText(getName("nemesis_item3_name"));
        item4Name.setText(getName("nemesis_item4_name"));
        item5Name.setText(getName("nemesis_item5_name"));
        item6Name.setText(getName("nemesis_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_starter_name", name);
                        saveImage("nemesis_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_relic1_name", name);
                        saveImage("nemesis_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_relic2_name", name);
                        saveImage("nemesis_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_item1_name", name);
                        saveImage("nemesis_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_item2_name", name);
                        saveImage("nemesis_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_item3_name", name);
                        saveImage("nemesis_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_item4_name", name);
                        saveImage("nemesis_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_item5_name", name);
                        saveImage("nemesis_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("nemesis_item6_name", name);
                        saveImage("nemesis_item6", resourceId);
