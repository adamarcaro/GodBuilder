...
public class FragmentXbalanque extends Fragment {

    View myView;

    public FragmentXbalanque() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_xbalanque, container, false);
        ...
        starter.setImageResource(getImage("xbalanque_starter"));
        relic1.setImageResource(getImage("xbalanque_relic1"));
        relic2.setImageResource(getImage("xbalanque_relic2"));
        item1.setImageResource(getImage("xbalanque_item1"));
        item2.setImageResource(getImage("xbalanque_item2"));
        item3.setImageResource(getImage("xbalanque_item3"));
        item4.setImageResource(getImage("xbalanque_item4"));
        item5.setImageResource(getImage("xbalanque_item5"));
        item6.setImageResource(getImage("xbalanque_item6"));

        //Loading build names
        starterName.setText(getName("xbalanque_starter_name"));
        relic1Name.setText(getName("xbalanque_relic1_name"));
        relic2Name.setText(getName("xbalanque_relic2_name"));
        item1Name.setText(getName("xbalanque_item1_name"));
        item2Name.setText(getName("xbalanque_item2_name"));
        item3Name.setText(getName("xbalanque_item3_name"));
        item4Name.setText(getName("xbalanque_item4_name"));
        item5Name.setText(getName("xbalanque_item5_name"));
        item6Name.setText(getName("xbalanque_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_starter_name", name);
                        saveImage("xbalanque_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_relic1_name", name);
                        saveImage("xbalanque_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_relic2_name", name);
                        saveImage("xbalanque_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_item1_name", name);
                        saveImage("xbalanque_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_item2_name", name);
                        saveImage("xbalanque_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_item3_name", name);
                        saveImage("xbalanque_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_item4_name", name);
                        saveImage("xbalanque_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_item5_name", name);
                        saveImage("xbalanque_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("xbalanque_item6_name", name);
                        saveImage("xbalanque_item6", resourceId);
