...
public class TabFragmentKhepri extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.khepri);
        godName.setText(R.string.khepri);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.khepri_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentKhepri1();
                case 1 : return new FragmentKhepri2();
                case 2 : return new FragmentKhepri3();
            }
            return null;
        }
