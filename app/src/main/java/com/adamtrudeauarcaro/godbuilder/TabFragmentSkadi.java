...
public class TabFragmentSkadi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.skadi);
        godName.setText(R.string.skadi);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_norse,0);
        godTitle.setText(R.string.skadi_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentSkadi1();
                case 1 : return new FragmentSkadi2();
                case 2 : return new FragmentSkadi3();
            }
            return null;
        }
