...
public class FragmentRa extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_ra, container, false);
        ...
        starter.setImageResource(getImage("ra_starter"));
        relic1.setImageResource(getImage("ra_relic1"));
        relic2.setImageResource(getImage("ra_relic2"));
        item1.setImageResource(getImage("ra_item1"));
        item2.setImageResource(getImage("ra_item2"));
        item3.setImageResource(getImage("ra_item3"));
        item4.setImageResource(getImage("ra_item4"));
        item5.setImageResource(getImage("ra_item5"));
        item6.setImageResource(getImage("ra_item6"));

        //Loading build names
        starterName.setText(getName("ra_starter_name"));
        relic1Name.setText(getName("ra_relic1_name"));
        relic2Name.setText(getName("ra_relic2_name"));
        item1Name.setText(getName("ra_item1_name"));
        item2Name.setText(getName("ra_item2_name"));
        item3Name.setText(getName("ra_item3_name"));
        item4Name.setText(getName("ra_item4_name"));
        item5Name.setText(getName("ra_item5_name"));
        item6Name.setText(getName("ra_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_starter_name", name);
                        saveImage("ra_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_relic1_name", name);
                        saveImage("ra_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_relic2_name", name);
                        saveImage("ra_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_item1_name", name);
                        saveImage("ra_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_item2_name", name);
                        saveImage("ra_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_item3_name", name);
                        saveImage("ra_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_item4_name", name);
                        saveImage("ra_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_item5_name", name);
                        saveImage("ra_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ra_item6_name", name);
                        saveImage("ra_item6", resourceId);
