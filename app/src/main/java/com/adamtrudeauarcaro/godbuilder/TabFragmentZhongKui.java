...
public class TabFragmentZhongKui extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.zhong_kui);
        godName.setText(R.string.zhong_kui);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.zhong_kui_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentZhongKui1();
                case 1 : return new FragmentZhongKui2();
                case 2 : return new FragmentZhongKui3();
            }
            return null;
        }
