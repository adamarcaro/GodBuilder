...
public class TabFragmentCabrakan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.cabrakan);
        godName.setText(R.string.cabrakan);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_mayan,0);
        godTitle.setText(R.string.cabrakan_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentCabrakan1();
                case 1 : return new FragmentCabrakan2();
                case 2 : return new FragmentCabrakan3();
            }
            return null;
        }
