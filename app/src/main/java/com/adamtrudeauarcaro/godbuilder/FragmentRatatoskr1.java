...
public class FragmentRatatoskr1 extends Fragment {

    View myView;

    public FragmentRatatoskr1() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        item1.setImageResource(getImage("ratatoskr_item1"));
        ...
        item1Name.setText(getName("ratatoskr_item1_name"));
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("ratatoskr_item1_name", name);
                        saveImage("ratatoskr_item1", resourceId);
