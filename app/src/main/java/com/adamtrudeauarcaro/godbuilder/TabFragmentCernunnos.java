...
public class TabFragmentCernunnos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.cernunnos);
        godName.setText(R.string.cernunnos);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_celtic,0);
        godTitle.setText(R.string.cernunnos_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentApollo1();
                case 1 : return new FragmentApollo2();
                case 2 : return new FragmentApollo3();
            }
            return null;
        }
