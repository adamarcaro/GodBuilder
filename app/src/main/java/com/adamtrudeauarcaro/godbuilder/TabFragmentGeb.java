...
public class TabFragmentGeb extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.geb);
        godName.setText(R.string.geb);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_egyptian,0);
        godTitle.setText(R.string.geb_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentGeb1();
                case 1 : return new FragmentGeb2();
                case 2 : return new FragmentGeb3();
            }
            return null;
        }
