...
public class TabFragmentHel extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        godImage.setImageResource(R.drawable.hel);
        godName.setText(R.string.hel);
        godName.setCompoundDrawablesWithIntrinsicBounds(0,0,R.drawable.icon_chinese,0);
        godTitle.setText(R.string.hel_title);
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new FragmentHel1();
                case 1 : return new FragmentHel2();
                case 2 : return new FragmentHel3();
            }
            return null;
        }
