...
public class FragmentMedusa2 extends Fragment {

    View myView;

    public FragmentMedusa2() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        starter.setImageResource(getImage("medusa_starter_2"));
        relic1.setImageResource(getImage("medusa_relic1_2"));
        relic2.setImageResource(getImage("medusa_relic2_2"));
        item1.setImageResource(getImage("medusa_item1_2"));
        item2.setImageResource(getImage("medusa_item2_2"));
        item3.setImageResource(getImage("medusa_item3_2"));
        item4.setImageResource(getImage("medusa_item4_2"));
        item5.setImageResource(getImage("medusa_item5_2"));
        item6.setImageResource(getImage("medusa_item6_2"));

        //Loading build names
        starterName.setText(getName("medusa_starter_name_2"));
        relic1Name.setText(getName("medusa_relic1_name_2"));
        relic2Name.setText(getName("medusa_relic2_name_2"));
        item1Name.setText(getName("medusa_item1_name_2"));
        item2Name.setText(getName("medusa_item2_name_2"));
        item3Name.setText(getName("medusa_item3_name_2"));
        item4Name.setText(getName("medusa_item4_name_2"));
        item5Name.setText(getName("medusa_item5_name_2"));
        item6Name.setText(getName("medusa_item6_name_2"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_starter_name_2", name);
                        saveImage("medusa_starter_2", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_relic1_name_2", name);
                        saveImage("medusa_relic1_2", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_relic2_name_2", name);
                        saveImage("medusa_relic2_2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item1_name_2", name);
                        saveImage("medusa_item1_2", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item2_name_2", name);
                        saveImage("medusa_item2_2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item3_name_2", name);
                        saveImage("medusa_item3_2", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item4_name_2", name);
                        saveImage("medusa_item4_2", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item5_name_2", name);
                        saveImage("medusa_item5_2", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemPhysFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("medusa_item6_name_2", name);
                        saveImage("medusa_item6_2", resourceId);
