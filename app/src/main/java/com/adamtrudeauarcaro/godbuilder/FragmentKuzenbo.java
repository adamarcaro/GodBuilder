...
public class FragmentKuzenbo extends Fragment {

    View myView;

    public FragmentKuzenbo() {
    }

    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.god_kuzenbo, container, false);
        ...
        starter.setImageResource(getImage("kuzenbo_starter"));
        relic1.setImageResource(getImage("kuzenbo_relic1"));
        relic2.setImageResource(getImage("kuzenbo_relic2"));
        item1.setImageResource(getImage("kuzenbo_item1"));
        item2.setImageResource(getImage("kuzenbo_item2"));
        item3.setImageResource(getImage("kuzenbo_item3"));
        item4.setImageResource(getImage("kuzenbo_item4"));
        item5.setImageResource(getImage("kuzenbo_item5"));
        item6.setImageResource(getImage("kuzenbo_item6"));

        //Loading build names
        starterName.setText(getName("kuzenbo_starter_name"));
        relic1Name.setText(getName("kuzenbo_relic1_name"));
        relic2Name.setText(getName("kuzenbo_relic2_name"));
        item1Name.setText(getName("kuzenbo_item1_name"));
        item2Name.setText(getName("kuzenbo_item2_name"));
        item3Name.setText(getName("kuzenbo_item3_name"));
        item4Name.setText(getName("kuzenbo_item4_name"));
        item5Name.setText(getName("kuzenbo_item5_name"));
        item6Name.setText(getName("kuzenbo_item6_name"));
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagStarterFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_starter_name", name);
                        saveImage("kuzenbo_starter", resourceId);
        ...
        relic1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_relic1_name", name);
                        saveImage("kuzenbo_relic1", resourceId);
        ...
        relic2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemRelicFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_relic2_name", name);
                        saveImage("kuzenbo_relic2", resourceId);
        ...
        item1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_item1_name", name);
                        saveImage("kuzenbo_item1", resourceId);
        ...
        item2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_item2_name", name);
                        saveImage("kuzenbo_item2", resourceId);
        ...
        item3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_item3_name", name);
                        saveImage("kuzenbo_item3", resourceId);
        ...
        item4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_item4_name", name);
                        saveImage("kuzenbo_item4", resourceId);
        ...
        item5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_item5_name", name);
                        saveImage("kuzenbo_item5", resourceId);
        ...
        item6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                dialog.setOnListItemSelectedListener(new ItemMagFragment.OnListItemClickedListener() {
                    public void onListItemClick(String name, int resourceId) {
                        saveName("kuzenbo_item6_name", name);
                        saveImage("kuzenbo_item6", resourceId);
